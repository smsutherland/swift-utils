...
def convert(snap_number, in_directory, out_directory=None, verbose=False):
    ...
    output_units['UnitTime_in_s'] = output_units['UnitLength_in_cm'] / output_units['UnitVelocity_in_cm_per_s']
        ...
        with h5py.File(f'{in_directory}/{snap}', 'r') as hf_in:
            ...
            fields = [
                ...
                ['PartType0/Coordinates', 'PartType0/Coordinates',
                    output_units['UnitLength_in_cm'] * scale_factor / hubble_param, False],
                ['PartType0/StarFormationRates', 'PartType0/StarFormationRate', 
                    output_units['UnitMass_in_g'] / output_units['UnitTime_in_s'], True],
                ['PartType0/Masses', 'PartType0/Masses',
                    output_units['UnitMass_in_g'] / hubble_param, False],
                ['PartType0/InternalEnergies', 'PartType0/InternalEnergy',
                    output_units['UnitVelocity_in_cm_per_s']**2, False],
                ['PartType0/Densities', 'PartType0/Density',
                    output_units['UnitMass_in_g'] * output_units['UnitLength_in_cm']**-3 *
                            scale_factor**-3 * hubble_param**2, False],
                ['PartType0/Velocities', 'PartType0/Velocities',
                    output_units['UnitVelocity_in_cm_per_s'] * scale_factor**0.5, False],
                ['PartType0/SmoothingLengths', 'PartType0/SmoothingLength',
                    output_units['UnitLength_in_cm'] * scale_factor / hubble_param, False],
                ...
                ['PartType4/Velocities', 'PartType4/Velocities',
                    output_units['UnitVelocity_in_cm_per_s'] * scale_factor**0.5, False],
                ['PartType4/SmoothingLengths', 'PartType4/SmoothingLength',
                    output_units['UnitLength_in_cm'] * scale_factor / hubble_param, False],
                ['PartType4/InitialMasses', 'PartType4/InitialMass', 
                    output_units['UnitMass_in_g'] / hubble_param, False],
                ['PartType4/BirthScaleFactors', 'PartType4/StellarFormationTime', 
                    None, False],
                ...
                ['PartType5/Velocities', 'PartType5/Velocities',
                    output_units['UnitVelocity_in_cm_per_s'] * scale_factor**0.5, False],
                ['PartType5/SmoothingLengths', 'PartType5/SmoothingLength',
                    output_units['UnitLength_in_cm'] * scale_factor / hubble_param, False],
                ['PartType5/AccretionRates', 'PartType5/Mdot',
                    output_units['UnitMass_in_g'] / output_units['UnitTime_in_s'], False],
            ]
            ...
            hf_out['Header'].attrs['Omega0'] = hf_in['Cosmology'].attrs['Omega_b'] +\
                hf_in['Cosmology'].attrs['Omega_cdm']
            hf_out['Header'].attrs['OmegaLambda'] = hf_in['Cosmology'].attrs['Omega_lambda']
